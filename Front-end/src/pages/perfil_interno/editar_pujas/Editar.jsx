         ...
         <form action="">
            <div className="crear-subasta">
               ...
               <section>
                  ...
                  <input type="file" id="imagen" accept="image/png, .jpeg, .jpg" onClick={SubirImagen} /> <br />
               ...
               <section>
                  ...
                  <input type="submit" className="iniciarSesion" value="Editar" />
                  <input type="submit" className="iniciarSesion" value="Eliminar" />
               </section>
            </div>
         </form>
